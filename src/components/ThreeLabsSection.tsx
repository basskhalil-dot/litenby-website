            ...
            >
              ...
              <div className="relative flex flex-1 flex-col p-6 lg:p-8">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="font-heading text-xl font-extrabold text-foreground lg:text-2xl">{lab.title}</h3>
                </div>
                <p className="text-sm leading-relaxed text-muted-foreground lg:text-base">{lab.description}</p>
              </div>
            </div>
          ))}
        </motion.div>
