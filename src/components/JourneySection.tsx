  ...
  return (
    <section className="w-full bg-background py-20 md:py-16 lg:py-20">
      <div className="container">
        ...
        <div className="mx-auto grid max-w-[300px] grid-cols-2 items-center gap-x-8 gap-y-10 px-6 md:hidden">
          <h2 className="justify-self-start self-start pt-1 font-heading text-[32px] font-extrabold lowercase leading-[0.92] text-primary">
            the<br />journey
          </h2>
          ...
          {journeySteps.map(({ id, title, icon: Icon }) => (
              <div
                key={id}
                className="flex min-h-[88px] flex-col items-center justify-center text-center"
              >
