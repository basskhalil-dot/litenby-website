...
const articles = [
  ...
  },
  {
    ...
    body: [
      ...
      "That's the part nobody talks about. A logo can be beautiful and still say nothing on a shelf. A bottle can be well-made and still clash with the story a brand is trying to tell. Not because anyone did bad work, but because nobody in the chain was looking at the whole picture.",
      "litenby exists because that gap is avoidable. Brand, packaging, and storytelling aren't three services stacked together — they're three angles on the same decision. The color that works on a logo has to work on a label.",
      "The tone in a tagline has to survive the trip from a screen to a shelf. When one person or one process owns all three, that consistency isn't a bonus. It's the whole point.",
  ...
  },
  {
    ...
    body: [
      ...
      "That's where the line came from: مئة سنة وبعدا البيارا عروس الكل, a hundred years, and Lapiara is still the bride of everyone. Not a slogan built in a meeting room. Something closer to what a family already says about a product that's been on their table since before they were born.",
  ...
  },
  {
    ...
    body: [
      ...
      "The line that carried the campaign said it plainly: مش بس زيت، كل مونة البيت, not just oil, the whole pantry. It wasn't a rebrand hiding behind clever language. It was the brand catching up to what it had already become.",
